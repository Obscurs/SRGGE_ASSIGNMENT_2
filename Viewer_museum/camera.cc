...
void Camera::MoveCentering(float x, float y, float z)
{

    centering_x_ +=x/10*cos(rotation_y_+M_PI/2)+z/10*cos(rotation_y_+M_PI);
    centering_y_ +=y/10;
    centering_z_ +=x/10*sin(rotation_y_+M_PI/2)+z/10*sin(rotation_y_+M_PI);
